...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Footer */}
      <footer className="relative overflow-hidden bg-gradient-to-br from-luxury-navy via-luxury-navy-light to-luxury-gold">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3 text-white/90">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-white/60">Quick response guaranteed</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 text-white/90">
                      <div className="w-10 h-10 bg-accent/20 rounded-full flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-white/60">Premium District, City 12345</div>
                      </div>
                    </div>
                  </div>
                </div>
